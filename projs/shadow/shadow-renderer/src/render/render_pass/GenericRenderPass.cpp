...
namespace vlkx {
    ...
    RenderPass::~RenderPass() {
        for (const auto& fb : framebuffers)
            vkDestroyFramebuffer(VulkanManager::getInstance()->getDevice()->logical, fb, nullptr);
        vkDestroyRenderPass(VulkanManager::getInstance()->getDevice()->logical, renderPass, nullptr);
    }

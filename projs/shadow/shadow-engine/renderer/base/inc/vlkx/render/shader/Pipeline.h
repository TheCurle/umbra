...
namespace vlkx {
    ...
    class GraphicsPipelineBuilder : public PipelineBuilder {
      public:
        ...
        fluent addVertex(uint32_t bindPoint,
    ...
    class ComputePipelineBuilder : public PipelineBuilder {
      public:
        ...
        fluent layout(std::vector<VkDescriptorSetLayout> &&descLayouts,
      ...
      public:
        ...
        static VkPipelineColorBlendAttachmentState getAlphaBlendState(bool blending) {
            return {
                ...
                VK_BLEND_OP_ADD, VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT
